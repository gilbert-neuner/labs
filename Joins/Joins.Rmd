...
<li><span style="color: red;"> How were the <span style="color: blue;">purchases</span> and <span style="color: blue;">survey</span> datasets collected? </span></li>
...
<li>In lab 2G, <span style="color: blue;">colors</span> and <span style="color: blue;">stress</span> had the same number of observations. Moreover, the values for <span style="color: blue;">user.id</span> were exactly the same in <span style="color: blue;">colors</span> and <span style="color: blue;">stress</span>.</li>
...
<li>The second kind of join function is <span style="color: blue;">outer_join</span>, which includes an observation when its ID is present in the left <b>OR</b> right datasets. In our example, this would be the set of people that made a purchase at the store <b>OR</b> filled out the survey. This is illustrated in the Venn diagram:</li>
...
<li>where <span style="color: blue;">"merge"</span> is replaced with the specific join function you'd like to use.</li>

<li><span style="color: red;">With this in mind, create an <span style="color: blue;">outer_join</span> of <span style="color: blue;">purchases</span> and <span style="color: blue;">survey</span>, and assign it to <span style="color: blue;">outer_customers</span>.</span></li>
