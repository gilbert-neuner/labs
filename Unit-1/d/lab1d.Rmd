...
```
- <span class="blue">`View` `food_salty` and write down the number of observations in it. Then use `food_salty` to make a dotPlot of the `sodium` in our `Salty` snacks.</span>
