...
<li><span style="color: red;">Use the <span style="color: blue;">data</span> command to obtain the <span style="color: blue;">pride</span> dataset, which consists of the words in <i>Pride and Prejudice</i>.</span></li>
...
<li><span style="color: red;">Use the <span style="color: blue;">data</span> command to obtain the <span style="color: blue;">stop_words</span> dataset, a list of stop words. <span style="color: blue;">View</span> the <span style="color: blue;">stop_words</span> dataset.</span></li>

<li><span style="color: red;">Create a new dataset containing observations of <span style="color: blue;">pride_words</span> that are not stop words. Assign this dataset to <span style="color: blue;">pride_words</span>.</span></li>
...
<li><span style="color: red;">Use the <span style="color: blue;">data</span> command to obtain the <span style="color: blue;">sentiments</span> dataset, a list of words along with the sentiments most commonly associated with them (<span style="color: blue;">"positive"</span> or <span style="color: blue;">"negative"</span>). <span style="color: blue;">View</span> the <span style="color: blue;">sentiments</span> dataset.</span></li>

<li><span style="color: red;">Inner join <span style="color: blue;">pride_words</span> and <span style="color: blue;">sentiments</span>, and assign the resulting dataset to <span style="color: blue;">pride_sentiments</span>.</span></li>
